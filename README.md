...
[![Build Status](https://travis-ci.org/thieman/dagobah.png?branch=master)](https://travis-ci.org/tthieman/dagobah?branch=master) ![PyPi version](https://pypip.in/v/dagobah/badge.png)
...
#### Tasks can even be run on remote machines (Set up hosts on the settings page, using your SSH config. [Details](https://github.com/rclough/dagobah/wiki/Adding-and-using-remote-hosts-in-Dagoba://github.com/thieman/dagobah/wiki/Adding-and-using-remote-hosts-in-Dagobah))
