...
#### Tasks can even be run on remote machines (Set up hosts on the settings page, using your SSH config. [Details](https://github.com/thieman/dagobah/wiki/Adding-and-using-remote-hosts-in-Dagobah))
